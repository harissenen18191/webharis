...
class pengaduan_F(FlaskForm):
    ...
    kategori= SelectField(u'Kategori Pengaduan', choices=[('adminitrasi','Pelayanan Administrasi'), ('fasilitas','Fasilitas'), ('dosen','Dosen')], validators=[DataRequired()] )
    detail_pengaduan= StringField('Pengaduan', validators=[DataRequired()])
